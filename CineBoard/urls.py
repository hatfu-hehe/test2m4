...
urlpatterns = [
    ...
    path('movies/', views.MovieCRUDListView.as_view(), name='movie_list'),
    ...
    path('genre/<int:genre_id>/', views.MoviesByGenreView.as_view(), name='movies_by_genre'),
    path('movies/<int:movie_id>/comment/', views.AddCommentView.as_view(), name='add_comment'),
    path('movies/<int:movie_id>/vip/', views.AddVipClientView.as_view(),name='add_vip'),
]
